...
update-translations:
	pybabel extract -F babel.cfg -k lazy_gettext -o like/translations/messages.pot .
	pybabel update -i like/translations/messages.pot -d like/translations/

add-translation:
	@read -p "Enter new language shortcode:" lang; \
	pybabel init -i like/translations/messages.pot -d like/translations/ -l $$lang

compile-translations:
	pybabel compile -d like/translations/
